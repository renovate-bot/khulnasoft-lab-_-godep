		...
		t.Run(pkg, func(t *testing.T) {
			...
			if pkg == "everydecl" {
				...
				wantLinks := []render.Link{
					{Href: "https://github.com/khulnasoft-lab/godep", Text: "godep repo"},
...
func TestVersionedPkgPath(t *testing.T) {
	for _, test := range []struct {
		...
		},
		{
			...
			pkgPath: "github.com/khulnasoft-lab/godep/internal/log",
			modInfo: &ModuleInfo{
				ModulePath:      "github.com/khulnasoft-lab/godep",
				ResolvedVersion: "v1.1.2",
				ModulePackages:  map[string]bool{"github.com/khulnasoft-lab/godep/internal/log": true},
			},
			want: "github.com/khulnasoft-lab/godep@v1.1.2/internal/log",
		},
		{
			...
			want: "github.com/khulnasoft-lab/godep@v0.0.0-20200709011933-a59b4ce778c4/internal/log",
		},
		{
