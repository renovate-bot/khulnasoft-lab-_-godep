...
import (
	...
	"github.com/khulnasoft-lab/godep/internal/experiment"
	pagepkg "github.com/khulnasoft-lab/godep/internal/frontend/page"
	"github.com/khulnasoft-lab/godep/internal/frontend/serrors"
	"github.com/khulnasoft-lab/godep/internal/frontend/templates"
	"github.com/khulnasoft-lab/godep/internal/frontend/urlinfo"
	...
	"github.com/khulnasoft-lab/godep/internal/memory"
...
type Server struct {
	...
	thirdPartyFS       fs.FS
	devMode            bool
	localMode          bool          // running locally (i.e. ./cmd/godep)
