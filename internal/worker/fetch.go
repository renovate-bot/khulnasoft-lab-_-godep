...
import (
	...
	"github.com/khulnasoft-lab/godep/internal/cache"
	...
	"github.com/khulnasoft-lab/godep/internal/log/stackdriverlogger"
...
func (f *Fetcher) FetchAndUpdateState(ctx context.Context, modulePath, requestedVersion, appVersionLabel string) (status int, resolvedVersion string, err error) {
	...
	if err == nil {
		...
		// modules that are introduced to godep for the first time via frontend
