...
// Godep extracts and generates documentation for Go programs.
// It runs as a web server and presents the documentation as a
// web page.
//
// To install, run `go install github.com/khulnasoft-lab/godep/cmd/godep@latest`.
//
// With no arguments, godep will serve docs for main modules relative to the
...
//	godep -cache -proxy
//
// With either -cache or -proxy, godep won't look for a module in the current
...
import (
	...
	"github.com/khulnasoft-lab/godep/internal/browser"
	"github.com/khulnasoft-lab/godep/internal/fetch"
	"github.com/khulnasoft-lab/godep/internal/fetchdatasource"
	"github.com/khulnasoft-lab/godep/internal/frontend"
	"github.com/khulnasoft-lab/godep/internal/log"
	"github.com/khulnasoft-lab/godep/internal/middleware/timeout"
	...
	"github.com/khulnasoft-lab/godep/static"
	thirdparty "github.com/khulnasoft-lab/godep/third_party"
)
