...
} from 'static/shared/header/header';
...
window.addEventListener('load', () => {
  ...
  for (const t of document.querySelectorAll<HTMLDetailsElement>(
    '.js-tooltip'
  )) {
  ...
  if (
    document.querySelector<HTMLElement>('.js-gtmID')?.dataset.gtmid &&
    window.dataLayer
  ) {
...
keyboard.on('y', 'set canonical url', () => {
  let canonicalURLPath = document.querySelector<HTMLDivElement>(
    '.js-canonicalURLPath'
