...
#c
# It mounts the pwd into a volume in the container at /godep,
# and sets the working directory in the container to /godep.

gocmd="dockercompose run go"
if type go > /dev/null; then
  # godep requires go1.16 or higher. If that's installed on the machine, just
